...
pub(crate) fn search_accessible(
    ...
    let mut seen_tracks = std::collections::HashSet::<DbId>::new();
    let mut seen_artists = std::collections::HashSet::<DbId>::new();
    let mut seen_releases = std::collections::HashSet::<DbId>::new();
