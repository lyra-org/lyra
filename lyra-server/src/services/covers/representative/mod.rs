...
fn required_user_listens(instance_profile: Option<&RepresentativeCoverProfile>) -> u64 {
...
fn user_signal_is_enough(
    user_profile: &RepresentativeCoverProfile,
    personal_winner: &RepresentativeCoverWinner,
    instance_profile: Option<&RepresentativeCoverProfile>,
) -> bool {
...
fn instance_signal_is_enough(instance_profile: &RepresentativeCoverProfile) -> bool {
...
fn profile_is_current(profile: &RepresentativeCoverProfile) -> bool {
    db::covers::representative::profile_is_clean(profile)
}
