...
pub(crate) const MAX_USER_AGENT_LEN: usize = 512;
...
impl SessionMetadata {
    fn normalized(self) -> Self {
        Self {
            user_agent: normalize_text(self.user_agent, MAX_USER_AGENT_LEN),
            client_name: normalize_text(self.client_name, MAX_CLIENT_NAME_LEN),
        }
    }
}
