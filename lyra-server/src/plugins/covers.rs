...
impl CoversModule {
    ...
    pub(crate) async fn get(lua: Lua, caller: RequestCaller, id: ResolveId) -> Result<Value> {
    ...
    pub(crate) async fn get_many(lua: Lua, caller: RequestCaller, ids: Table) -> Result<Table> {
