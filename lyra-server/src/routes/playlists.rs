...
struct PlaylistResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[schemars(description = "Playlist creation time in epoch milliseconds.")]
    created_at_ms: Option<u64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    #[schemars(description = "Playlist update time in epoch milliseconds.")]
...
fn playlist_to_response(
    ...
    Ok(PlaylistResponse {
        ...
        tracks,
        owner_id,
        created_at_ms: playlist.created_at.map(super::unix_secs_to_ms_u64),
        updated_at_ms: playlist.updated_at.map(super::unix_secs_to_ms_u64),
    })
}
