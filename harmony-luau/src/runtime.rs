...
impl Luau {
    ...
    /// Likely to be dropped once typed return conversion exists. This is a
    /// narrow smoke-test convenience, not the intended final evaluation API.
    pub fn eval_number(
        &self,
        chunk_name: &str,
        source: impl AsRef<[u8]>,
...
impl LuauFunction<'_> {
    /// Re-evaluate when argument and return conversion lands. The final call
    /// API should be typed and support multi-value returns.
