...
impl Scope {
    pub fn new(id: impl Into<Arc<str>>, description: &'static str, danger: Danger) -> Self {
        Self {
            id: id.into(),
            description,
            danger,
    ...
    pub fn generated(module_path: &str) -> Self {
        Self::new(module_path.replace('/', "."), "", Danger::Negligible)
    }
    ...
    pub fn danger(mut self, danger: Danger) -> Self {
        self.danger = danger;
        self
    }
}
