...
impl DescribeUserData for HttpMethod {
    fn class_descriptor() -> ClassDescriptor {
        ClassDescriptor::new("HttpMethod", None)
            .variants(["Get", "Post", "Put", "Delete", "Patch", "Head"])
    }
}
...
impl DescribeInterface for HttpRequestOptions {
    fn interface_descriptor() -> InterfaceDescriptor {
        InterfaceDescriptor::new("HttpRequestOptions", None)
            ...
            .field_type::<HttpMethod>("method")
            .field_type::<Option<LuaBinaryInput>>("body")
            .field_type::<Option<HttpHeaderMap>>("headers")
            .field_type::<Option<HttpHeaderMap>>("cookies")
    }
}
...
impl DescribeInterface for HttpRateLimitOptions {
    fn interface_descriptor() -> InterfaceDescriptor {
        InterfaceDescriptor::new("HttpRateLimitOptions", None)
            .field_type::<String>("domain")
            .field(
                FieldDescriptor::of::<Option<f64>>("requests_per_second")
                    .description("Defaults to `1.0`."),
            )
            .field_type::<Option<Vec<u16>>>("retry_on")
            .field(
                FieldDescriptor::of::<Option<u32>>("max_retries").description("Defaults to `3`."),
            )
            .field(
                FieldDescriptor::of::<Option<u64>>("backoff_ms").description("Defaults to `1000`."),
            )
    }
}
...
impl DescribeInterface for HttpResponse {
    fn interface_descriptor() -> InterfaceDescriptor {
        InterfaceDescriptor::new("HttpResponse", None)
            .field_type::<bool>("success")
            .field_type::<Option<u16>>("status_code")
            .field_type::<String>("status_message")
            .field_type::<HttpHeaderMap>("headers")
            .field_type::<HttpHeaderMap>("cookies")
            .field_type::<BodyBytes>("body")
            .field(
                FieldDescriptor::of::<Option<String>>("error_kind")
                    .description("Transport error category when `success` is false."),
            )
            .field_type::<u32>("retries")
            .field_type::<bool>("rate_limited")
    }
}
