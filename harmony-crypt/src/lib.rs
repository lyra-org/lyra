...
fn module_export() -> ModuleExport {
    ModuleBuilder::empty("harmony/crypt", "Crypt", "crypt")
        .description("Cryptographic hashing, encoding, and random byte generation helpers.")
        .scope_id(
            "harmony.crypt",
            "Hashing, random bytes, and base64 encoding utilities.",
            Danger::Negligible,
        )
        .type_alias::<HashAlgorithm>()
        .sync_function(
            ModuleFunctionDescriptor::new("hash")
                .description(
                ...
                .param(ParameterDescriptor::of::<HashAlgorithm>("algorithm"))
                .param_type::<String>("data")
                .returns::<String>(),
            hash,
        )
        .sync_function(
            ModuleFunctionDescriptor::new("base64.encode")
        ...
        .sync_function(
            ModuleFunctionDescriptor::new("base64.decode")
                .description("Decodes a base64 string back into raw bytes.")
                .param_type::<String>("data")
                .returns::<String>(),
            base64_decode,
        )
        .sync_function(
            ModuleFunctionDescriptor::new("random")
                .description(
