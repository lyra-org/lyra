...
mod tests {
    ...
    fn transcode_to_file(output_path: &str, format: &str, codec: &str, min_size: u64) {
        ...
        let output = Output::new(output_path)
            .set_raw_format(format)
            .set_raw_audio_codec(codec)
            .set_raw_audio_codec_opt("b", "192k");
    ...
    fn test_remux_to_caf_file() {
        ...
        let output = Output::new(output_path).set_raw_format("caf");
    ...
    fn reports_callback_error() {
        let output = Output::with_callback(|_| WriteResult::error("sink failed"))
            .set_raw_format("mp3")
            .set_raw_audio_codec("libmp3lame")
            .set_raw_audio_codec_opt("b", "192k");
