...
impl Output {
    ...
    pub(crate) fn set_raw_audio_codec(mut self, codec: impl Into<String>) -> Self {
    ...
    pub(crate) fn set_raw_audio_codec_opt(
        mut self,
    ...
    pub(crate) fn set_raw_swr_opt(mut self, key: impl Into<String>, value: impl Into<String>) -> Self {
    ...
    pub fn audio_abr_bitrate_kbps(mut self, kbps: u32) -> Self {
        self.audio_codec_opts.insert("abr".to_string(), "1".to_string());
        self.audio_bitrate_kbps(kbps)
    }
